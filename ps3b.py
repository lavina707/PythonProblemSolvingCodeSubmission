...
def comp_choose_word(hand, word_list):
    ...
    """
    # TO DO...
    ##I don't understand this problem. I have some issue to understand this problems.
...
def play_game(word_list):
    ...
    * If the user inputs anything else, ask them again.
    ...
    def play_game(wordList):
     while True:
            user_game = str(input('Enter n to deal a new hand, r to replay the last hand, or e to end game: '))
        if user_game == 'e':
            break
        elif user_game == 'n':
            ...
            try:
                play_game(hand, wordList, hand_size)
            except:
